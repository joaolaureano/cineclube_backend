...
export class createTables1619891457572 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TABLE platform (id int NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
      "CREATE TABLE tag (id int NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE actor (id int NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
