...
export class createTables1619891457572 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TABLE movie (id int SERIAL, title varchar(255) NOT NULL, originalTitle varchar(255) NOT NULL, synopsis text NOT NULL, critic text NOT NULL, curator varchar(255) NOT NULL, year char(4) NOT NULL, pathBanner text NOT NULL, duration int NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
      "CREATE TABLE platform (id int SERIAL, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
      "CREATE TABLE tag (id int SERIAL, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TABLE actor (id int SERIAL, name varchar(255) NOT NULL, created_At timestamp NOT NULL DEFAULT NOW(), updated_At timestamp NOT NULL DEFAULT NOW() , PRIMARY KEY (id))"
    );
    await queryRunner.query(
